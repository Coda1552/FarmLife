...
public class FLBlocks {
    ...
    public static final RegistryObject<Block> POTTED_PEACOCK_BURST_POPPY = BLOCKS.register("potted_peacock_burst_poppy", () -> new FlowerPotBlock(PEACOCK_BURST_POPPY.get(), BlockBehaviour.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final RegistryObject<Block> POTTED_ELECTRIC_BURST_POPPY = BLOCKS.register("potted_electric_burst_poppy", () -> new FlowerPotBlock(ELECTRIC_BURST_POPPY.get(), BlockBehaviour.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final RegistryObject<Block> POTTED_FANCY_BURST_POPPY = BLOCKS.register("potted_fancy_burst_poppy", () -> new FlowerPotBlock(FANCY_BURST_POPPY.get(), BlockBehaviour.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final RegistryObject<Block> POTTED_OLIVE_BURST_POPPY = BLOCKS.register("potted_olive_burst_poppy", () -> new FlowerPotBlock(OLIVE_BURST_POPPY.get(), BlockBehaviour.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final RegistryObject<Block> POTTED_RUSTY_BURST_POPPY = BLOCKS.register("potted_rusty_burst_poppy", () -> new FlowerPotBlock(RUSTY_BURST_POPPY.get(), BlockBehaviour.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final RegistryObject<Block> POTTED_SUNSTREAK_BURST_POPPY = BLOCKS.register("potted_sunstreak_burst_poppy", () -> new FlowerPotBlock(SUNSTREAK_BURST_POPPY.get(), BlockBehaviour.Properties.of(Material.DECORATION).instabreak().noOcclusion()));

    public static final RegistryObject<Block> TRIBULL_MILK_CAULDRON = BLOCKS.register("tribull_milk_cauldron", () -> new TribullMilkCauldronBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.STONE).requiresCorrectToolForDrops().strength(2.0F).noOcclusion().randomTicks()));
