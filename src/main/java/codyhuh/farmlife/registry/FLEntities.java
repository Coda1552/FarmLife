...
public class FLEntities {
    ...
    public static final RegistryObject<EntityType<Platefish>> PLATEFISH = create("platefish", EntityType.Builder.of(Platefish::new, MobCategory.WATER_CREATURE).sized(0.9f, 0.4f).noSummon()); // todo - remove noSummon for release
